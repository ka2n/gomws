...
func NewClient(config gmws.MwsConfig) (*Reports, error) {
	report := new(Reports)
	base, err := gmws.NewMwsBase(config, report.Version(), report.Name())
	if err != nil {
		return nil, err
	}
	report.MwsBase = base
...
func (r Reports) RequestReport(reportType string, optional ...gmws.Parameters) *mwsHttps.Response {
...
func (r Reports) GetReportRequestList(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{
		"ReportRequestIdList", "ReportTypeList", "ReportProcessingStatusList",
		"MaxCount", "RequestedFromDate", "RequestedToDate",
	}, optional)
	params := gmws.Parameters{"Action": "GetReportRequestList"}.Merge(op)
...
func (r Reports) GetReportRequestListByNextToken(nextToken string) *mwsHttps.Response {
	params := gmws.Parameters{
...
func (r Reports) GetReportRequestCount(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{
		"RequestedFromDate", "RequestedToDate", "ReportTypeList", "ReportProcessingStatusList",
	}, optional)
	params := gmws.Parameters{"Action": "GetReportRequestCount"}.Merge(op)
...
func (r Reports) CancelReportRequests(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{
		"ReportRequestIdList", "ReportTypeList", "ReportProcessingStatusList",
		"RequestedFromDate", "RequestedToDate",
	}, optional)
	params := gmws.Parameters{"Action": "CancelReportRequests"}.Merge(op)
	structuredParams := params.StructureKeys("ReportRequestIdList", "Id").
		StructureKeys("ReportTypeList", "Type").
		StructureKeys("ReportProcessingStatusList", "Status")
...
func (r Reports) GetReportList(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{
		"MaxCount", "ReportTypeList", "Acknowledged",
		"AvailableFromDate", "AvailableToDate", "ReportRequestIdList",
	}, optional)
	params := gmws.Parameters{"Action": "GetReportList"}.Merge(op)
	structuredParams := params.StructureKeys("ReportRequestIdList", "Id").
		StructureKeys("ReportTypeList", "Type")
...
func (r Reports) GetReportListByNextToken(nextToken string) *mwsHttps.Response {
	params := gmws.Parameters{
...
func (r Reports) GetReportCount(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{
		"ReportTypeList", "Acknowledged",
		"AvailableFromDate", "AvailableToDate",
	}, optional)
	params := gmws.Parameters{"Action": "GetReportCount"}.Merge(op)
	structuredParams := params.StructureKeys("ReportTypeList", "Type")
...
func (r Reports) GetReport(reportID string) *mwsHttps.Response {
	params := gmws.Parameters{
		"Action":   "GetReport",
		"ReportId": reportID,
	}
...
func (r Reports) ManageReportSchedule(reportType string, schedule string, optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{"ScheduleDate"}, optional)
	params := gmws.Parameters{
...
func (r Reports) GetReportScheduleList(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{"ReportTypeList"}, optional)
	params := gmws.Parameters{"Action": "GetReportScheduleList"}.Merge(op)
	structuredParams := params.StructureKeys("ReportTypeList", "Type")
...
func (r Reports) GetReportScheduleCount(optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{"ReportTypeList"}, optional)
	params := gmws.Parameters{"Action": "GetReportScheduleCount"}.Merge(op)
	structuredParams := params.StructureKeys("ReportTypeList", "Type")
...
func (r Reports) UpdateReportAcknowledgements(ids []string, optional ...gmws.Parameters) *mwsHttps.Response {
	op := gmws.OptionalParams([]string{"Acknowledged"}, optional)
	params := gmws.Parameters{
